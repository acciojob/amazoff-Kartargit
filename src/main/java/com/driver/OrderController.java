...
OrderService serviceLayerObj = new OrderService();
    ...
    public ResponseEntity<String> addPartner(@PathVariable String partnerId){
        serviceLayerObj.addPartner(partnerId);
    ...
    public ResponseEntity<Order> getOrderById(@PathVariable String orderId){
        ...
        Order order= serviceLayerObj.getOrder(orderId);
    ...
    public ResponseEntity<DeliveryPartner> getPartnerById(@PathVariable String partnerId){
        ...
        DeliveryPartner deliveryPartner = serviceLayerObj.getPartner(partnerId);
    ...
    public ResponseEntity<Integer> getOrderCountByPartnerId(@PathVariable String partnerId){
        ...
        Integer orderCount = serviceLayerObj.getPartnerOrders(partnerId);
    ...
    public ResponseEntity<List<String>> getOrdersByPartnerId(@PathVariable String partnerId){
        List<String> orders = serviceLayerObj.getPartnerOrderList(partnerId);
